...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> findItem(int userId, int itemId) {
        return get("/" + itemId, userId);
    }

    public ResponseEntity<Object> findUserItems(int userId, int from, int size) {
    ...
    public ResponseEntity<Object> findItems(int userId, String searchString, int from, int size) {
        Map<String, Object> parameters = Map.of(
                "text", searchString,
                "from", from,
                "size", size
